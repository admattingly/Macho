/*
 * KMF3 - CIPHER MESSAGE WITH CIPHER FEEDBACK with CC=3 loop and static buffers
 */
...
#pragma export(KMF3)
#else
#pragma prolog(KMF3, main)
#pragma epilog(KMF3, main)
#endif
        ...
        MACHO_DWORD     pticks)        /* (output)       elapsed clock ticks */
{
    ...
    while (CC == 3) {
        ...
        __asm(" STCKF %[start]        Get start timestamp            \n"
              ...
              " KMF   %[out],%[in]    Invoke KMF instruction         \n"
