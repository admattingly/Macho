/*
 * DFLTCC3 - DEFLATE CONVERSION CALL with CC=3 loop and static buffers
 */

#include "macho.h"

#ifdef __64BIT__
#pragma export(DFLTCC3)
#else
#pragma prolog(DFLTCC3, main)
#pragma epilog(DFLTCC3, main)
#endif
        ...
        MACHO_INTEGER   pticks)        /* (output)       elapsed clock ticks */
{
    ...
    while (CC == 3) {
        ...
        __asm(" STCKF  %[start]              Get start timestamp            \n"
              ...
              " DFLTCC %[out],%[in],%[chb]   Invoke DFLTCC instruction      \n"
