/*
 * KMAC3 - COMPUTE MESSAGE AUTHENTICATION CODE with CC=3 loop and static buffers
 */
...
#pragma export(KMAC3)
#else
#pragma prolog(KMAC3, main)
#pragma epilog(KMAC3, main)
#endif
...
//  R1plus1 = *pR1plus1;
    ...
    while (CC == 3 && R2plus1 != 0) {
        ...
        __asm(" STCKF %[start]        Get start timestamp            \n"
              ...
              " KMAC  0,%[in]         Invoke KMAC instruction        \n"
