/*
 * KIMD3 - COMPUTE INTERMEDIATE MESSAGE DIGEST with CC=3 loop and static buffers
 */
...
#pragma export(KIMD3)
#else
#pragma prolog(KIMD3, main)
#pragma epilog(KIMD3, main)
#endif
...
//  R1plus1 = *pR1plus1;
    ...
    while (CC == 3 && R2plus1 != 0) {
        ...
        __asm(" STCKF %[start]        Get start timestamp            \n"
              ...
              " KIMD  0,%[in]         Invoke KIMD instruction        \n"
