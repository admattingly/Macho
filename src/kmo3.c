/*
 * KMO3 - CIPHER MESSAGE WITH OUTPUT FEEDBACK with CC=3 loop and static buffers
 */
...
#pragma export(KMO3)
#else
#pragma prolog(KMO3, main)
#pragma epilog(KMO3, main)
#endif
        ...
        MACHO_INTEGER   pticks)        /* (output)       elapsed clock ticks */
{
    ...
    while (CC == 3 && R2plus1 != 0) {
        ...
        __asm(" STCKF %[start]        Get start timestamp            \n"
              ...
              " KMO   %[out],%[in]    Invoke KMO instruction         \n"
